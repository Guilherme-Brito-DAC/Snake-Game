const jogoElement: HTMLElement = document.getElementById("jogo")
let pontos: number = 0

class Jogo {
    private colunas: number = 16
    private linhas: number = 16
...
class Cobra {
    private velocidadeX: number = 1
    private velocidadeY: number = 0
    private corpo: Array<Array<number>> = []
    private jogo: Jogo
